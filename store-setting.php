          ...
          <div class="row">
            <div class="col-12">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Details Start -->
                  <form class="theme-form theme-form-2 mega-form" action="querryCode/storeCode.php" method="POST"
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" name="store_name" value="<?php echo $store_name; ?>"
                                type="text" placeholder="Enter Your Store Name">
                            </div>
                          </div>
                          ...
                          <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" name="store_location" value="<?php echo $Store_location; ?>"
                                type="text" placeholder="Enter Your Store Location">
                            </div>
                          </div>
                          ...
                          <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" value="<?php echo $phone; ?>" name="store_phone" type="number"
                          ...
                          <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" name="store_email" value="<?php echo $email; ?>" type="email"
                          ...
                          <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-6">
                              <input class="form-control form-choose" onChange="handleLogo(event)" name="store_logo"
                                type="file" id="formFileMultiple">
                            </div>
                            <div class="col-sm-4">
                              <img src="<?php echo $img_src_logo; ?>" alt="" class="rounded m-1" id="logoImg"
                                width="100">
                            </div>
                          </div>

                          <div class="mb-4 row align-items-center">
                            <label class="col-sm-2 col-form-label form-label-title">Store Banner</label>
                            <div class="form-group col-sm-6">
                              <div class="dropzone-wrapper" style="cursor:pointer" onClick="dropzoneAreaClick()">
                                ...
                                <input type="file" id="bannerInput" name="store_banner"
                                  onChange="handleChangeFile(event)" accept="image/jpeg, image/png, image/jpg"
                                  class="dropzone">
                              </div>
                            </div>
                            <div class="form-group col-sm-4">
                              <img src="<?php echo $img_src_banner; ?>" alt="" class="rounded mt-2" id="bannerImg"
                                width="280">
                            </div>
                          </div>
                    ...
                    <?php if ($store_id == "") { ?>
                            <div style="padding-right:30px !important; margin-bottom:20px;">
                              <button name="addStore" type="submit" class="btn ms-auto theme-bg-color text-white">Add
                            ...
                            <div >
                              <button style="margin-bottom:20px;" name="UpdateStore" id="updateProfileBtn" type="submit"
