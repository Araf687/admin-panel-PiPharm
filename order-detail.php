            ...
            if ( $querry_result == true ) {
                ...
                if ( $count>0 ) {
                    while( $rows = mysqli_fetch_assoc( $querry_result ) ) {
                        ...
                        if($item_image == '') {
                          $item_image = 'default-image.jpg';
                        }

                        ?>
                              <tr class="table-order">
                                <td>
                                    <img width="50" src="<?php echo "assets/images/product/".$item_image ?>" class="img-fluid blur-up lazyload">
                                </td>
                      ...
                      <div class="col-xl-4">
                        <div class="order-success">
                          <div class="row g-4">
                            ...
                            <ul class="order-details">
                              <li><?php echo "Address: " . $address[0]; ?></li>
                              <li><?php echo "City: " . $address[1]?></li>
                              <li><?php echo "State: " . $address[2]; ?></li>
                              <li><?php echo "Phone: " . $contact; ?></li>
                            </ul>
