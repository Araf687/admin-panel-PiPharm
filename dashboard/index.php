                  ...
                  <div class="custome-1-bg b-r-4 card-body">
                    <div class="media align-items-center static-top-widget">
                      <div class="media-body p-0">
                        ...
                        <h4 class="mb-0 counter">$<?php echo $totalReveneue;?></h4>
                      </div>
                  ...
                  <div>
                    <div class="table-responsive">
                      <table class="best-selling-table w-image w-image w-image table border-0">
                        <tbody>
                        <?php
                            $fetchBestSellingProd="SELECT 
                            product.prd_name, product.prd_price,
                            SUM(orderitems.qty) AS total_sales 
                          FROM orderitems, product
                          WHERE orderitems.prod_id = product.prd_id AND product.admin_id=$admin_id
                          GROUP BY product.prd_name 
