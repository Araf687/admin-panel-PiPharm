                      ...
                      <div class="card-header-2">
                        ...
                        <form class="theme-form theme-form-2 mega-form" action="querryCode/categoryCode.php" method="POST" enctype="multipart/form-data">
                            ...
                            ?>
                                ...
                                <input value=<?php echo $cat_id;?> type="integer" style="display:none;" name="cat_id">
                                <!-- end -->

                                <label class="form-label-title col-sm-3 mb-0">Category Name</label>
                                <div class="col-sm-9">
                                    <input class="form-control" value=<?php echo $cat_name;?> type="text" name="cat_name" placeholder="Category Name">
                                </div>
                                </div>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" name="isFeatured[]" type="checkbox" value="Featured Category" id="flexCheckChecked" <?php echo $isFeatured;?>>
                                  <label class="form-check-label" for="flexCheckChecked">
                                    Featured Category
                                  </label>
                                </div>
                            <?php }}}?>
                            <button type="submit" name="UpdateCategory" class="btn ms-auto theme-bg-color text-white">Update Category</button>
                        </form>
